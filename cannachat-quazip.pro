...
QT       += core gui network sql printsupport multimedia multimediawidgets opengl
...
linux {
DEFINES += zlib QUAZIP DOWNLOAD SMTP SOUND DBUS STORAGE FTP MEDIAPLAYER PYTHON FIGLET IRRLICHT
...
win32 {
DEFINES += zlib IRRLICHT QUAZIP
CONFIG +=
LIBS += -lstdc++ -lz -lm -lopengl32 -lIrrlicht
QT += multimedia svg dbus network
}

win642 {
DEFINES += SOUND MEDIAPLAYER FIGLET QUAZIP zlib STORAGE FTP IRRLICHT
CONFIG += barcodescan
LIBS +=
QT += multimedia svg dbus network
}
